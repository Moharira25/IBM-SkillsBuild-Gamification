...
/*    static {
    ...
    public void run(String... args) throws Exception {
        ...
        String[] questions = {"What is an AI agent?", "Which of the following is NOT a characteristic of an intelligent agent?", "Which type of agent operates in a dynamic environment, taking actions based on the information it receives?", "What is the primary function of a utility-based agent?", "Which agent type uses internal models to simulate the consequences of potential actions?", "What does the term 'sensory perception' refer to in the context of AI agents?", "Which agent type adjusts its behavior based on feedback from the environment?", "In the context of AI agents, what does autonomy mean?", "Which type of agent uses a predefined set of rules and actions to make decisions?", "What distinguishes a learning agent from other types of agents?", "Which type of agent typically uses a utility function to evaluate the desirability of different states?", "What is the role of a performance measure in an AI agent?", "Which agent type focuses on maximizing a cumulative utility function over time?", "What is the key advantage of a reactive agent?", "Which agent type is best suited for environments with well-defined rules and clear objectives?"};

        String[] choicesA = {"a) A person who works with artificial intelligence", "a) Autonomy", "a) Utility-based agent", "a) To react to stimuli from its environment", "a) Utility-based agent", "a) The ability to understand emotions", "a) Utility-based agent", "a) The ability to function without human intervention", "a) Utility-based agent", "a) Its ability to react to stimuli from the environment", "a) Utility-based agent", "a) To evaluate the performance of the agent", "a) Utility-based agent", "a) Its ability to plan and reason about future actions", "a) Utility-based agent"};

        String[] choicesB = {"b) A software program that acts on behalf of a user or another program", "b) Reactivity", "b) Reactive agent", "b) To learn from past experiences and improve its performance", "b) Reactive agent", "b) The ability to perceive and interpret information from the environment", "b) Reactive agent", "b) The ability to collaborate with other agents", "b) Reactive agent", "b) Its ability to use utility functions to make decisions", "b) Reactive agent", "b) To determine the utility function", "b) Reactive agent", "b) Its ability to adapt to changing environments", "b) Reactive agent"};

        String[] choicesC = {"c) An organization specializing in AI research", "c) Sensory perception", "c) Deliberative agent", "c) To maximize a performance measure based on utility function", "c) Deliberative agent", "c) The ability to communicate with other agents", "c) Deliberative agent", "c) The ability to adapt to changing environments", "c) Deliberative agent", "c) Its ability to improve its performance over time through experience", "c) Deliberative agent", "c) To provide sensory input to the agent", "c) Deliberative agent", "c) Its simplicity and efficiency", "c) Deliberative agent"};

        String[] choicesD = {"d) A hardware component used in AI systems", "d) Fixed behavior", "d) Learning agent", "d) To follow a predefined set of rules and actions", "d) Learning agent", "d) The ability to learn from past experiences", "d) Learning agent", "d) The ability to perceive and interpret sensory information", "d) Learning agent", "d) Its ability to simulate potential actions before executing them", "d) Learning agent", "d) To define the environment in which the agent operates", "d) Learning agent", "d) Its capability to learn from past experiences", "d) Learning agent"};

        String[] answers = {"b) A software program that acts on behalf of a user or another program", "d) Fixed behavior", "b) Reactive agent", "c) To maximize a performance measure based on utility function", "c) Deliberative agent", "b) The ability to perceive and interpret information from the environment", "d) Learning agent", "a) The ability to function without human intervention", "b) Reactive agent", "c) Its ability to improve its performance over time through experience", "a) Utility-based agent", "a) To evaluate the performance of the agent", "a) Utility-based agent", "c) Its simplicity and efficiency", "c) Deliberative agent"};
